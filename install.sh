...
APT_PKGS="zsh bash neovim python-pip python-neovim optipng python3 curl conky parallel nodejs ruby ruby-dev redis-server postgresql terminator build-essential gnome-shell-extensions gnome-tweak-tool git fonts-dejavu fonts-inconsolata automake autoconf libreadline-dev libncurses-dev libssl-dev libyaml-dev libxslt-dev libffi-dev libtool unixodbc-dev"
PAC_PKGS="zsh zsh-autosuggestions zsh-completions nvme-cli bash neovim python-neovim python2-neovim optipng python3 curl conky parallel nodejs ruby redis postgresql terminator base-devel gnome-shell-extensions git ttf-inconsolata ttf-dejavu gnome-tweaks"
